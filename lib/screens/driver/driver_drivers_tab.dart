...
class _DriverDriversTabState extends State<DriverDriversTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentDriverId = currentUser?.referenceId ?? '';
    ...
    return StreamBuilder<List<Map<String, String>>>(
      stream: notificationService.watchMessagesForDriver(currentDriverId),
      builder: (context, messagesSnapshot) {
        final messages = messagesSnapshot.data ?? const [];

        return FutureBuilder<Driver?>(
          future: referenceDataService.getDriverById(currentDriverId),
          builder: (context, snapshot) {
            final currentDriver = snapshot.data;
                  ...
                  AppSurfaceCard(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          currentDriver?.name ?? currentUser?.name ?? '',
